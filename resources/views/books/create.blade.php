<x-layouts.app>
    ...
    <form action="/books" method="post" class="mt-4 space-y-4">
        ...
        <div class="space-y-1">
            ...
            <input type="text" name="title" id="title" class="rounded block w-full border-2	border-gray-300">
            @error('title')
        ...
        <div class="space-y-1">
            ...
            <input type="text" name="author" id="author" class="rounded block w-full border-2 border-gray-300">
            @error('author')
                <div class="text-red-500 text-sm">
                    {{ $message }}
                </div>
